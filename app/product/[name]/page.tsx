  ...
  return (
    ...
    <div className='flex m-2 mt-11 '>
        <div className=' basis-2/4'>
            <Image src={searchParams.image} alt={searchParams.name} width={400} height={400} className='w-full' priority={true}/>
        </div>
        <div className='flex-col gap-4 pl-12 basis-2/4'>
            ...
            <strong><p className='text-primary'>{searchParams.unit_amount && formatPrice(searchParams.unit_amount)}</p> </strong>
